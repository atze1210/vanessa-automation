...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюФормуДокументаЗаполненногоНаОснованииПроведенногоНомерОт(Парам01,Парам02,Парам03,Парам04)","ЯОткрываюФормуДокументаЗаполненногоНаОснованииПроведенногоНомерОт","Когда Я открываю форму документа ""АвтоВзаимозачет"" заполненного на основании проведенного ""ПоступлениеАвтомобилей"" номер ""АИ00000002"" от ""12.03.2017""",
		"### Описание
		|Форма открывается прямо в сеансе, где запущена Vanessa Automation, — это дымовой шаг менеджера тестирования, клиент тестирования ему не нужен. Открытие формы на основании проведенного документа.
		|В отличие от <И я открываю форму документа 'АвтоВзаимозачет' заполненного на основании проведенного 'ПоступлениеАвтомобилей'>,
		|документ-основание берётся не любой, а с указанными номером и датой. Дату пишут в формате `дд.ММ.гггг`.
		|Если документа с таким номером и датой нет, шаг **не падает**, а берёт последний проведённый документ этого вида —
		|как если бы номер и дата не указывались вовсе.
		|Шаг дымовой: он проверяет, что форма ввода на основании открывается и заполняется без ошибок.
		|### Пример. Ввод на основании конкретного документа
		|Форма `АвтоВзаимозачет` откроется заполненной по документу `ПоступлениеАвтомобилей` номер `АИ00000002` от 12.03.2017.
		|```Gherkin
		|	Когда Я открываю форму документа 'АвтоВзаимозачет' заполненного на основании проведенного 'ПоступлениеАвтомобилей' номер 'АИ00000002' от '12.03.2017'
		|	И я закрываю текущее окно
		|```
		|","UI.Формы.Ввод на основании");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюФормуДокументаЗаполненногоНаОснованииПроведенного(Парам01,Парам02)","ЯОткрываюФормуДокументаЗаполненногоНаОснованииПроведенного","И я открываю форму документа ""АвтоВзаимозачет"" заполненного на основании проведенного ""ПоступлениеАвтомобилей""",
		"### Описание
		|Форма открывается прямо в сеансе, где запущена Vanessa Automation, — это дымовой шаг менеджера тестирования, клиент тестирования ему не нужен. Открытие формы на основании проведенного документа.
		|Документ-основание шаг ищет сам: берётся **последний по дате** проведённый документ указанного вида без пометки удаления.
		|Если подходящего документа в базе нет, шаг завершается ошибкой «Для <ИмяДокумента> не найдено документа основания».
		|Шаг дымовой: он проверяет, что форма ввода на основании открывается и заполняется без ошибок,
		|а не то, чем именно она заполнилась.
		|Когда основание нужно конкретное, берут <Когда Я открываю форму документа 'АвтоВзаимозачет' заполненного на основании проведенного 'ПоступлениеАвтомобилей' номер 'АИ00000002' от '12.03.2017'>.
		|### Пример. Дымовая проверка ввода на основании
		|Форма откроется заполненной по последнему проведённому поступлению; закрывает её сам шаг, отдельного закрытия не нужно.
		|```Gherkin
		|	И я открываю форму документа 'АвтоВзаимозачет' заполненного на основании проведенного 'ПоступлениеАвтомобилей'
		|```
		|","UI.Формы.Ввод на основании");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюФормуДокументаЗаполненногоНаОснованииНеПроведенногоНомерОт(Парам01,Парам02,Парам03,Парам04)","ЯОткрываюФормуДокументаЗаполненногоНаОснованииНеПроведенногоНомерОт","Когда Я открываю форму документа ""АвтоВзаимозачет"" заполненного на основании не проведенного ""ПоступлениеАвтомобилей"" номер ""АВ00000080"" от ""04.09.2016""",
		"### Описание
		|Форма открывается прямо в сеансе, где запущена Vanessa Automation, — это дымовой шаг менеджера тестирования, клиент тестирования ему не нужен. Открытие формы на основании не проведенного документа с указанными номером и датой. Дату пишут в формате `дд.ММ.гггг`.
		|Если документа с таким номером и датой нет, шаг берёт последний непроведённый документ этого вида.
		|Непроведённое основание — отдельный случай: часть механизмов заполнения на него не рассчитана, и дымовой тест это ловит.
		|### Пример. Ввод на основании конкретного непроведённого документа
		|Форма `АвтоВзаимозачет` откроется заполненной по непроведённому документу номер `АВ00000080` от 04.09.2016.
		|```Gherkin
		|	Когда Я открываю форму документа 'АвтоВзаимозачет' заполненного на основании не проведенного 'ПоступлениеАвтомобилей' номер 'АВ00000080' от '04.09.2016'
		|	И я закрываю текущее окно
		|```
		|","UI.Формы.Ввод на основании");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯОткрываюФормуДокументаЗаполненногоНаОснованииНеПроведенного(Парам01,Парам02)","ЯОткрываюФормуДокументаЗаполненногоНаОснованииНеПроведенного","И я открываю форму документа ""АвтоВзаимозачет"" заполненного на основании не проведенного ""ПоступлениеАвтомобилей""",
		"### Описание
		|Форма открывается прямо в сеансе, где запущена Vanessa Automation, — это дымовой шаг менеджера тестирования, клиент тестирования ему не нужен. Открытие формы на основании не проведенного документа.
		|Основание шаг ищет сам: берётся последний по дате непроведённый документ указанного вида без пометки удаления.
		|Если такого документа в базе нет, шаг завершается ошибкой «Для <ИмяДокумента> не найдено документа основания».
		|Парный шаг для проведённых оснований — <И я открываю форму документа 'АвтоВзаимозачет' заполненного на основании проведенного 'ПоступлениеАвтомобилей'>.
		|### Пример. Дымовая проверка на непроведённом основании
		|```Gherkin
		|	И я открываю форму документа 'АвтоВзаимозачет' заполненного на основании не проведенного 'ПоступлениеАвтомобилей'
		|	И я закрываю текущее окно
		|```
		|","UI.Формы.Ввод на основании");
