...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	+ Символы.ПС + "- Цвет (Color) - строка, из перечисления WebЦвета, например ""Зеленый""."
	+ Символы.ПС + "- Длительность (Duration) - сколько миллисекунд рамка будет находиться на экране, например - 2000."
	...
	|Заводит именованный профиль, но не включает его. Основным он становится отдельным шагом: `И я устанавливаю основной профиль цвета 'Заголовки'`. Нужно, когда в одном сценарии текст ищется в разных местах интерфейса: в списке шрифт один, в шапке отчёта другой, в чужом приложении третий.
