...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		|При поиске окна можно использовать символы * для поиска по шаблону. Поиск без учёта регистра.
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,
		...
		"### Описание
		|Активизирует процесс по его заголовку или части заголовка, заданной маской.
		|При поиске окна можно использовать символы * для поиска по шаблону. Поиск без учёта регистра.
		|То же, что <И я активизирую процесс ""PID"">, но искать PID заранее не нужно — окно находится по заголовку. Шаблон проверяется на полное совпадение с заголовком окна, поэтому часть заголовка ищите маской со звёздочками: `*Блокнот*` найдёт окно с любым именем файла.
...
Процедура ПолученСписокОконОС(Результат, ДополнительныеПараметры) Экспорт
	...
	Для Каждого ДанныеПроцесса Из Данные Цикл
		...
		Если Ванесса.СтрокаСоответствуетШаблону(НРег(ДанныеПроцесса.Title), НРег(ПараметрЗаголовок)) Тогда
