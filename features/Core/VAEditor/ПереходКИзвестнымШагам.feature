...
Сценарий: Переход к известным шагам из редактора
	...
	* Установка нужной строки текущей
		...
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setPosition(12, 1, \"\");'
	...
	* Переход в дерево известных шагов
		...
		Тогда элемент формы с именем "ДеревоШаговОписаниеШага" стал равен '*Позволяет сохранить в переменную произвольное выражение встроенного языка*' по шаблону
		
	* Установка строки между шагами
		И Я закрываю окно 'Известные шаги*'
		И я перехожу к закладке с именем "ГруппаСлужебная"
		И я перехожу к закладке с именем "ГруппаСлужебноеВыполнитьКод"
		И в поле с именем 'РеквизитПроизвольныйКод' я ввожу текст 'VanessaTabs.current.editor.setPosition(14, 1, \"\");'
		И я нажимаю на кнопку с именем 'ВыполнитьПроизвольныйКод'
		И Пауза 1
		И я перехожу к закладке с именем "ГруппаЗапускТестов"
	...
	* Переход в дерево известных шагов к ближнему шагу снизу
		...
		Тогда открылось окно 'Известные шаги*'
		//И в таблице "ДеревоШагов" я активизирую поле с именем "ДеревоШаговОписаниеШага"
		Тогда элемент формы с именем "ДеревоШаговОписаниеШага" стал равен '*Вводит текст в поле. Также вводит текст в форматированный документ и поле HTML документа*' по шаблону
