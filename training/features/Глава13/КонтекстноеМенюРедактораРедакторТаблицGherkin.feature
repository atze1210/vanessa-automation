...
Сценарий: Контекстное меню редактора. Таблицы Gherkin.
	...
	* Данный пункт меню позволяет начать редактирование таблицы в специальном окне. Горячая клавиша, контрол, плюс, шифт, плюс тэ.
		...
		//И Я делаю подсветку элемента VA "СгенерированныйСценарийКонтекстноеМенюРедактироватьТаблицуТекст" "Редактировать таблицу" и перемещаю курсор

	* А этот пункт меню выравнивает разметку всех таблиц Gherkin в тексте фичи.
		И Я делаю подсветку элемента VA "VanessaEditorКонтекстноеМенюВыровнятьТаблицыGherkin" "Выровнять таблицы" и перемещаю курсор
