...
Процедура СоздатьПоставку(КаталогОткуда,КаталогКуда)
	...
	ОчиститьКаталог(КаталогКуда + ПолучитьРазделительПути() + "tools\SPPR");
	...
	ОчиститьКаталог(КаталогКуда + ПолучитьРазделительПути() + ".zcode");
	ОчиститьКаталог(КаталогКуда + ПолучитьРазделительПути() + "_tools");
	ОчиститьКаталог(КаталогКуда + ПолучитьРазделительПути() + "temp");
	
	УдалитьФайлы(КаталогКуда + ПолучитьРазделительПути() + ".git");
	УдалитьФайлы(КаталогКуда + ПолучитьРазделительПути() + ".zcode");
	УдалитьФайлы(КаталогКуда + ПолучитьРазделительПути() + "_tools");
	УдалитьФайлы(КаталогКуда + ПолучитьРазделительПути() + "temp");
	...
	УдалитьФайлы(КаталогКуда + ПолучитьРазделительПути() + "tools\SPPR");
