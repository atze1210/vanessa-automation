...
Функция КоллекцияКомандЗапуска() Экспорт
	...
	КоллекцияКоманд.Вставить("ОбъединятьПримерыСтруктурыСценарияВAllure", Новый Структура("Р, А", "ОбъединятьПримерыСтруктурыСценарияВAllure", "MergeScenarioOutlineExamplesInAllure"));
	...
	КоллекцияКоманд.Вставить("ЗаписьВидеоСкоростьПроизношенияТекстаБезОзвучки", 
		Новый Структура("Р, А", "ЗаписьВидеоСкоростьПроизношенияТекстаБезОзвучки", "speedofspeechwithouttts"));
	...
	КоллекцияКоманд.Вставить("РазмерБуфераЛогаВыполненияСценариев", Новый Структура("Р, А", "РазмерБуфераЛогаВыполненияСценариев", "textlogbuffersize"));
